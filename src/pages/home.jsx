    ...
    <main className="my-2">
      <div className="w-100 flex flex-wrap flex-col">
        ...
        <section className="flex flex-col my-4 xl:px-40 lg:px-32 md:px-28 sm:px-24 px-4 w-100">
          ...
          <span className="text-xl text-center">
            Первое стихотворение опубликовано в газете "Советский спорт" в 1949
            году. Произведение, которое прославило его в 1952 году, - поэма
            "Братская ГЭС". Написал книгу "Голубь в Сантьяго", в которой
            затронул политические темы. Не чужды ему тонкая и интимная лирика, а
            также поэмы и циклы стихотворений по зарубежной и антивоенной
            тематике.
          </span>
        </section>
